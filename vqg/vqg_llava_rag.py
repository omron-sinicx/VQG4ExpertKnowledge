...
##Should not
    ...
    5. DO NOT mention the existence of other clips.
...
#comm_data = json.load(open("log_formal/qa_val_samples_5_video_w_desc.json", "r", encoding="utf-8"))
comm_data = json.load(open("log_formal/qa_val_samples_5_video_w_desc_eval.json", "r", encoding="utf-8"))
log_path = Path(f"log_formal/log_video_llava_fps10_rag_exo_zsst.txt")
training_samples = []
...
for video in tqdm(comm_data):
    ...
    for entry in video["annotations"]:
        ...
        with open(log_path, "a", encoding="utf-8") as f:
            #f.write(f"Video ID: {entry['video_ego']}\n")
...
out_path = Path(f"log_formal/qa_llava_fps10_rag_exo_zsst.json")
