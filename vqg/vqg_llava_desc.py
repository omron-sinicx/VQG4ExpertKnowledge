...
##Should not
    ...
    6. DO NOT mention the existence of the narration.
...
log_path = Path(f"log_formal/log_llava_fps10_exo_wcaption.txt")
training_samples = []
...
out_path = Path(f"log_formal/qa_llava_fps10_exo_wcaption.json")
