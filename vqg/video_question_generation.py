...
def prepare_prompt(entry,scenario_name, task_name):
    ...
    prompt_nochance = f"""You are an AI assistant tasked with generating insightful questions. You will be observing a task video.
#Goal
...
ONLY output one question.
    ...
    prompt_withNarration = f"""You are an AI assistant tasked with generating insightful questions. You will be observing a task video in egocentric view. You will also be provided with a narration of the video with timestamp, which may include descriptions of actions.
...
##Should not
    1. DO NOT ask for general evaluations, summaries, opinions or suggestions, such as:
        ...
        - "What are the main points of the expert commentary?" (or other semantically similar phrases)
    2. DO NOT use multiple question words in one question (such as "Why is  ..., and how does...?")
    3. The presence of the narration should not be mentioned. DO NOT use words like "according to the narration" or "based on the narration" in your question. DO NOT mention the time stamp in your question.
    4. DO NOT use words like "according to the expert" or other similar phrases.
    5. DO NOT use words like "in the video" or other similar phrases.
    
##Output format
ONLY output one question.
    """
    prompt_withtask = f"""You are an AI assistant tasked with generating insightful questions. You will be observing a task video.

#Task
This is a video of person conducting {scenario_name} task, which is a {task_name} task.
    ...
    video_messages = [
        ...
        {"role": "user", "content": [
            {"type": "text", "text": prompt_withNarration},
            {
                ...
                'fps': 10.0  # The default value is 2.0, but for demonstration purposes, we set it to 3.0.
            }]
        },
    ]
...
log_path = Path(f"log_formal/log_video_fps10_ego_wcap.txt")
training_samples = []
...
out_path = Path(f"log_formal/qa_fps10_ego_wcap.json")
