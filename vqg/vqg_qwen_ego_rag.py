...
# In my case, both decord and torchcodec encountered video load freezing issues, so I used torchvision. (FORCE_QWENVL_VIDEO_READER="torchvision")
...
log_path = Path(f"log_formal/log_video_rag_ego_zsst.txt")
training_samples = []
...
out_path = Path(f"log_formal/qa_rag_ego.json")
