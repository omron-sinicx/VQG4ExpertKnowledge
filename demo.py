...
def prepare_prompt(entry,scenario_name, task_name):
    try:
        ...
        # if you want to generate questions based on ego videos, use follows:
    ...
    # This is the prompt for video-only VQG.
...
ONLY output one question.
    ...
    # This is a prompt for video with narration VQG.
...
comm_data = json.load(open("annotations/qa_val_samples_video_w_desc_eval.json", "r", encoding="utf-8"))
log_path = Path("log_video_exo.txt")
training_samples = []
