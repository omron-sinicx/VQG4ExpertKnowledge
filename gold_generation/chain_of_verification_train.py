...
with open("qa_seed_train_2s.json", encoding="utf-8") as f:
    seeds = json.load(f)
...
# output and log
training_samples = []
log_path = Path(f"log_formal/train_{args.entry}.txt")
...
#Output format
- If the question follows the rules, only ouput:
OK
...
out_path = Path(f"log_formal/qa_train_samples.json")
