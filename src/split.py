"""
A script to split the generated validation json into test set and database(for RAG in our paper) set.
(Optional) Create the FAISS index for RAG.
"""
...
with open("annotations/qa_val_samples_video_w_desc_db.json", "w") as f:
    json.dump(db_videos, f, indent=4)
with open("annotations/qa_val_samples_video_w_desc_eval.json", "w") as f:
    json.dump(eval_videos, f, indent=4)

#----------------above is to split the data----------------

#----------------below is to prepare the segments for FAISS index. If you do not need RAG or you want to customize, you can skip this part----------------
...
IDX_OUT     = "annotations/comment_db.index"
TXT_OUT     = "annotations/comment_texts.json"
